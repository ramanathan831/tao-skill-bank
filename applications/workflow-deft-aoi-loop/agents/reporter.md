...
- **skill_root**: absolute path to the `workflow-deft-aoi-loop` skill directory — `references/DEFT_Loop_Report.html` and `references/REPORT_RENDERING.md` live here
