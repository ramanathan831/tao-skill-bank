...
Full Phase 0 commands and content for the `tao-hf-integration` skill — system prerequisite checks plus the one-time preparation of the published TAO Toolkit container images that the rest of the workflow runs inside. Linked from the SKILL.md Phase 0 summary.
