...
`tao-hf-finetune` on <YYYY-MM-DD>. All commands assume you `cd` into the project
...
NGC/Docker/transformers errors consult the error playbook in `tao-hf-finetune`."*
...
- Generator: `tao-hf-finetune` on <YYYY-MM-DD>
