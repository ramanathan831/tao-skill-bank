...
Final status:
- Partially validated: all train/evaluate/inference/export/prune/resume, AutoML default train, and deploy actions pass; quantize is blocked by current toolkit/default-image defects.
