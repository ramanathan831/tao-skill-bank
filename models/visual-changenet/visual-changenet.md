...
No default NGC pretrained checkpoint is required -- the backbone weights are bundled in the container at `/workspace/weights/`.
...
Visual ChangeNet classify expects CSV files with four columns:
